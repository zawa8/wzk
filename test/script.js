...
wzkobz.fromstr = "both";
wzkobz.tostr = "all";
wzkobz.istr = 'ऋषि';// सुनक , महर्षि वाल्मीकि , संस्कृत रामायण के प्रथम रचयिता हैं जो आदिकवि के रूप में प्रसिद्ध हैं ' ;
...
wzkobz.duztr();
for (key in  wzkobz.odikt) {
	console.log(`wzkobz.odikt[${key}]: ${wzkobz.odikt[key]}\n`); 
}
//wzkobz.ioft_tr(ioft);
...
console.log("istr: \n" + istr + "\nestr is:\n" + estr + "\n"); 
let tstr = wzkobz.itr(istr,"both","inglish");
...
estr = 'A A A\nAα Aα Aα\nk p m'
console.log("istr: \n" + istr + "\nestr is:\n" + estr + "\n"); 
tstr = wzkobz.itr(istr,"both","inglish");
console.log("tstr is:\n" + tstr); 
////// test 3
...
for (const k in cases) { assert.equal(wzkobz.itr(k,"both","inglish"), cases[k]) }
////// test 5
...
ing31str = wzkobz.itr(unicode_str,"both","inglish");
...
////// test 3
unicode_str = 'ऋषि सुनक , महर्षि वाल्मीकि , संस्कृत रामायण के प्रथम रचयिता हैं जो आदिकवि के रूप में प्रसिद्ध हैं ' ;
ioft={i:unicode_str,o:{},f:"both",wzkobz:"all"};
console.log("unicode_str is:\n" + unicode_str + "\n"); 
wzkobz.ioft_tr(ioft);
console.log("ioft.o.bangla is:\n" + ioft.o["bangla"] + "\n");
